const { override, fixBabelImports, addLessLoader,addBabelPresets, addBabelPlugins } = require('customize-cra');
...
module.exports = override(
  ...
  addLessLoader({
    ...
    modifyVars: {
      '@primary-color'        : '#6a0e98',
      '@font-family'          : 'Roboto',
      // '@input-height-base'    : '10px'
